# Em quais dias de um mês e ano lidos houve queda no preço da ação? Qual o preço de abertura e o preço do fechamento na data e a variação do preço em moeda corrente? Observação: há queda no preço quando o valor de abertura é maior que o de fechamento.
